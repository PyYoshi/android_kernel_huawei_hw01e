...
static void check_hung_task(struct task_struct *t, unsigned long timeout)
{
	...
	int idx, first_empty_item = -1, i = 0;
...
/* storage proccess names in [pname] to [pname_table], and return the numbers of process */
...
/* since the proccess name written into [pname_table] may be different from original input, [p_name] should be modified to adjust [pname_table] */
