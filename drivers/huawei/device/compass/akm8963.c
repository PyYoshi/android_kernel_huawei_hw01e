...
{
    struct akm8963_data *akm = container_of(
		handler, struct akm8963_data, early_suspend);
 ...
 /* IRQ */
	...
	if (s_akm->irq == 0) {
		...
		err = request_threaded_irq(
				...
				NULL,
				akm8963_irq,
				//IRQ_TYPE_EDGE_RISING,//IRQF_TRIGGER_HIGH|IRQF_ONESHOT,
   ...
   #ifdef CONFIG_HAS_EARLYSUSPEND
	s_akm->early_suspend.suspend = akm8963_early_suspend;
	s_akm->early_suspend.resume = akm8963_early_resume;
