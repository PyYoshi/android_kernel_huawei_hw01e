...
/*Add sensor self adapt*/
static void l3g4200d_get_layout(struct l3g4200d_data *gyro)
{
	gyro->pdata->axis_map_x = 1;
	gyro->pdata->axis_map_y = 0;
	gyro->pdata->axis_map_z = 2;
	if(is_gyro_sensor_layout_top())
	{
		gyro->pdata->negate_x = 1;
...
static struct device_attribute attributes[] = {
    __ATTR(pollrate_ms, (S_IRUGO|S_IWUSR|S_IWGRP), attr_polling_rate_show,
                        attr_polling_rate_store),
    __ATTR(range, (S_IRUGO|S_IWUSR|S_IWGRP), attr_range_show, attr_range_store),
    __ATTR(enable_device, (S_IRUGO|S_IWUSR|S_IWGRP), attr_enable_show, attr_enable_store),
    __ATTR(enable_selftest, (S_IRUGO|S_IWUSR|S_IWGRP), attr_get_selftest, attr_set_selftest),
#ifdef DEBUG
