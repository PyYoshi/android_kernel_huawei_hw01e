...
config_pair  hw_U9201L_VA_configs [] = {
    ...
    {"product/name", (const unsigned int)(unsigned int*)"U9201L_VA", E_CONFIG_DATA_TYPE_STRING }, 
...
struct board_id_general_struct config_common_U9201L_VA= {
	.name=COMMON_MODULE_NAME,
	.board_id=BOARD_ID_U9201L_VA,
	.data_array={.config_pair_ptr=hw_U9201L_VA_configs},
	.list={NULL,NULL},
};
