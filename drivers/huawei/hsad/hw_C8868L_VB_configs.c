...
config_pair  hw_C8868L_VB_configs [] = {
    ...
    {"product/name", (const unsigned int)(unsigned int*)"C8868L_VB", E_CONFIG_DATA_TYPE_STRING }, 
...
struct board_id_general_struct config_common_C8868L_VB= {
	.name=COMMON_MODULE_NAME,
	.board_id=BOARD_ID_C8868L_VB,
	.data_array={.config_pair_ptr=hw_C8868L_VB_configs},
	.list={NULL,NULL},
};
